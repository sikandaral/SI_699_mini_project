...
- `data/US-National-Parks_Use_1979-2023_By-Month.csv` — raw by-month NPS
...
- `src/npdata.py` — data loading, cleaning, and statistical helpers
  (trend regression with HAC standard errors, seasonality metrics,
  shift-share decomposition).
- `src/npviz.py` — shared, accessibility-checked plotting style (colour
